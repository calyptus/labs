...
new ART.Ellipse(100, 100).translate(50, 50).fill('#0f0').blur().inject(group);
...
new ART.Font('Moderna', 'normal', 'S', 80).translate(220, 0).fill('#99F').scale(8).blur(2).inject(group);

new ART.Font('Moderna', 'normal', 'S', 500).translate(300, 50).fill('#0f0').inject(group);



//art.toElement().style.filter = "progid:DXImageTransform.Microsoft.Alpha(opacity=50)";
