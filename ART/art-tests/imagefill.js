...
var el = new ART.Ellipse(200, 100).fillRadial(['#000', '#F00', '#FFF'], .15, .5, .5, .5, .5).translate(500, 200).inject(group);
...
el.fillImage('flowers.png', 70, 138, 'rgba(255, 255, 255, 1)', 'rgba(255, 0, 0, .5)');
